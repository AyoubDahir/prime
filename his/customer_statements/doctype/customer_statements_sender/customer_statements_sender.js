...
frappe.ui.form.on('Customer Statements Sender', {
  ...
  send_customer_statements: function (frm) {
    ...
    frappe.confirm(
      ...
      function () {
        frappe.call({
          method: "prime.api.api.statements_sender_scheduler",
          args: {
            manual: true
          },
          callback: function (r) {
  ...
  preview: function (frm) {
    if (frm.doc.customer != undefined && frm.doc.customer != "") {
      frappe.call({
        method: "prime.api.api.get_report_content_byinvoice",
        args: {
  ...
  summary_statement: function (frm) {
    if (frm.doc.customer) {
      frappe.call({
        method: "prime.api.api.get_summary_statement",
        args: {
          company: frm.doc.company,
  ...
  send_email: function (frm) {
    if (frm.doc.customer != undefined && frm.doc.customer != "") {
      frappe.call({
        method: "prime.api.api.send_individual_statement",
        args: {
          company: frm.doc.company,
          customer: frm.doc.customer,
          from_date: frm.doc.from_date,
