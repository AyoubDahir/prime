frappe.pages['ipd-order'].on_page_load = function(wrapper) {
	new IpdOrder(wrapper)
}

IpdOrder = Class.extend(
	{
		...
		// alert(currdate)
		frappe.call({
        method: "prime.api.get_orders.get_ipd_orders", //dotted path to server method
		...
		// console.log(columns)
this.table = new Tabulator("#ipdorder", {
			// layout:"fitDataFill",
...
<div id="ipdorder"  style = "min-width : 100%"></div>
