	...
	finance= Class.extend({
		init: function(wrapper){
			...
			frappe.call({
				...
				method: 'prime.dashboard_and_history.finance.get_data',
			...
			frappe.call({
					method: 'prime.dashboard_and_history.finance.account_balance',
					callback: function(r) {
						let account_html = ``
			...
			frappe.call({
					method: 'prime.dashboard_and_history.finance.payables',
					callback: function(r) {
						let payables_html = ``
	...
	generateData(value, i1, i2, step = 1) {
		...
		cards:function(){
			...
			frappe.call({
				...
				method: 'prime.dashboard_and_history.finance.insurance',
