...
frappe.ui.form.on('Daily casheir cash closing', {
	...
	refresh(frm) {
		...
		frappe.call({
                ...
                method: "prime.api.api_cashier.Get_Cashier_Account", //dotted path to server method
                args: {
...
// frm.custom_buttons["Send"].css("background-color", "red");
        ...
        //             frappe.call({
        //                 method: "prime.api.api_cashier.Daily_Cashier_Status", //dotted path to server method
        //                 args: {
        //                     "cash_in_hand" : frm.doc.cash_in_hand,
        //                     "posting_date" : date,
        //                     "user" : name,
        ...
        //         frappe.call({
        //             method: "prime.api.api_cashier.Create_new_doc_cash_closing", //dotted path to server method
        //             args: {
	...
	send: function(frm){
		  ...
		  console.log(note)
      	 frappe.call({
                    method: "prime.api.api_cashier.note", //dotted path to server method
                    args: {
                        "note" : note,
                        "posting_date" :date,
                        "user" : name
	...
	request: function(frm){
	    if(frm.doc.status=="Requesting To Approve"){
		  ...
		  console.log(recash+date+name+status)
      	 frappe.call({
                    method: "prime.api.api_cashier.request", //dotted path to server method
                    args: {
                        "recash" : recash,
                        'account': frm.doc.account,
                        "posting_date" :date,
