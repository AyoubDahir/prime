...
frappe.ui.form.on('Surgery Preparation', {
	...
	refresh: function(frm) {
		frappe.call({
			method: "prime.prime.doctype.surgery_preparation.surgery_preparation.get_billed_items", //dotted path to server method
			args :{
		...
		if (!frm.is_new()){
			...
			// 	// 			frappe.call({
			// 	// 					method: "prime.api.refer.refer", //dotted path to server method
			// 	// 					args: {
			// 	// 						"patient" : frm.doc.patient,
			...
			// 				frappe.call({
			// 						method: "prime.prime.doctype.surgery_preparation.surgery_preparation.make_ot_schedule", //dotted path to server method
			// 						args: {
