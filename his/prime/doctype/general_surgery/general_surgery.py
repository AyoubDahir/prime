...
from prime.api.general_sergery import set_so_values_from_db
from prime.api.general_sergery import enqueue_sales_orders


class GeneralSurgery(Document):
...
def transfer(**args):
	...
	frappe.db.set_value("General Surgery", args.get('name'), "status", "Transferred")
