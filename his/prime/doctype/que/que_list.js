    ...
    btn = {
        ...
        action: function(doc) {
            ...
            // frappe.msgprint(doc.patient_name)
             ...
             frappe.call({
                    method: "prime.api.checkfollowup.Check_follow_up", //dotted path to server method
                    args: {
                        "patient" : doc.patient
     ...
     callback: function(res) {
        ...
        frappe.call({
        method: "prime.api.Que_to_fee_validity.make_que", //dotted path to server method
        args: {
        ...
        action: function(doc) {
            ...
            if(r.patient_encounter){
                ...
                frappe.set_route("Form","Patient Encounter", r.patient_encounter) 
                    ...
                    // console.log(rs)
            // alert(r.refer_request)
            frappe.new_doc("Patient Encounter",{"que": doc.name, "patient": r.patient,"practitioner" : r.practitioner,"refer_request":r.refer_request}) 
