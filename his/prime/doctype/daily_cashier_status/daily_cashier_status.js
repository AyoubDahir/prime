...
//   frm.set_value("user",frm.doc.user)
      ...
      var start_btn=  frm.add_custom_button(__("Reject"), function(){
       ...
       frm.toggle_reqd("messege", true) 
        ...
        //console.log(date +' '+user);
                    ...
                    frappe.call({
                    method: "prime.api.api_cashier.daily_cashier_closing_status", //dotted path to server method
                    args: {
                        "pos_date" : date,
                        "user" : user,
                        "status" : status,
  ...
  on_submit: function(frm){
    //   frappe.msgprint("akdajsdkjashdkjsajkhkj")
        ...
        var user = frm.doc.user;
               frappe.call({
                    method: "prime.api.api_cashier.daily_cashier_approved", //dotted path to server method
                    args: {
                        "pos_date" : date,
                        "user" : user,
                   },
