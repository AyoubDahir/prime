...
frappe.pages['opd-dashboard'].on_page_load = function(wrapper) {
	...
	Opd_dashboard= Class.extend({
		...
		frappe.call({
				...
				method: 'prime.api.dashboard.doctorwise',
...
// -------------------------------------------------------------------------------------------
		...
		frappe.call({
				...
				method: 'prime.api.dashboard.doctor_wise_income',
...
// -------------------------------------------------------------------------------------------
		...
		frappe.call({
				...
				method: 'prime.api.dashboard.patient_wise_income',
...
// -------------------------------------------------------------------------------------------
		frappe.call({
				...
				method: 'prime.api.dashboard.departmentwise',
		...
		// -----------------------------------------------------------------------------------------
				...
				method: 'prime.api.dashboard.open_que',
				...
				method: 'prime.api.dashboard.doctor_wise_que',
...
// -----------------------------------------------------------------------------------------
				...
				method: 'prime.api.dashboard.department_wise_que',
		...
		frappe.call({
				...
				method: 'prime.api.dashboard.today',
		...
		// this.generateData("Math.sin(x)", 0, 0, 0.5);
			...
			options: {
				...
				frappe.call({
				method: 'prime.api.dashboard.account_balance',
				callback: function(data) {
		...
		$("#week").click(function(){
			frappe.call({
					...
					method: 'prime.api.dashboard.week',
	...
	$("#month").click(function(){
		frappe.call({
				...
				method: 'prime.api.dashboard.month',
...
$("#year").click(function(){
	frappe.call({
			...
			method: 'prime.api.dashboard.year',
...
$("#all").click(function(){
	frappe.call({
			...
			method: 'prime.api.dashboard.all',
	...
	generateData(value, i1, i2, step = 1) {
		...
		cards:function(){
			...
			frappe.call({
				...
				method: 'prime.api.dashboard.cards',
