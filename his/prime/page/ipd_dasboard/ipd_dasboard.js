...
// // -----------------------------------------------------------------------------------------
	...
	make: function() {
		...
		frappe.call({
			...
			method: 'prime.api.ipd_dashboard.admit_dashboard',
		...
		frappe.call({
			...
			method: 'prime.api.ipd_dashboard.discharge_p_da',
		...
		frappe.call({
			...
			method: 'prime.api.ipd_dashboard.admission_ordered',
		...
		frappe.call({
			...
			method: 'prime.api.ipd_dashboard.doctor_plan',
		...
		frappe.call({
			...
			method: 'prime.api.ipd_dashboard.bed_status',
