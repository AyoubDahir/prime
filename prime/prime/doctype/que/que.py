...
from prime.api.Que_to_make_sales_invove import make_invoice
from prime.api.Que_to_fee_validity import make_fee_validity
from prime.api.que_token_number import token_numebr
from prime.api.order_to_bill import create_que_order_bill
class Que(Document):
