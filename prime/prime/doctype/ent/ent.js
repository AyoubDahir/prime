...
frappe.ui.form.on('ENT', {
	...
	if(! out_side){
            ...
            frappe.call({
                    method: "prime.prime.doctype.ent.ent.refer", //dotted path to server method
                    args: {
                ...
                let d = new frappe.ui.Dialog({
                    ...
                    primary_action(values) {
                          let diagnose = d.get_value("diagnose")
                            ...
                            frappe.call({
                                    method: "prime.prime.doctype.ent.ent.transfer", //dotted path to server method
                                    args: {
                                        "diagnose" : diagnose,
                                        'patient':frm.doc.patient,
                                        'name': frm.doc.name,
