...
fetch(`${baseUrl}/api/method/prime.www.get_lab_test.get_ot_rooms` , options)
...
fetch(`${baseUrl}/api/method/prime.dashboard_and_history.p_history.get_p_histy` , options)
.then(response => response.json())
.then(r => {
let tbldata = []
let lab_data = []
   ...
   if(tab == "labs"){
    ...
    data.forEach(element => {
       ...
       body :JSON.stringify({
        ...
        fetch(`${baseUrl}/api/method/prime.www.get_lab_test.get_lab_doc` , options_no)
...
var cols = `
    ...
    data.forEach(element => {
       ...
       body :JSON.stringify({
        ...
        fetch(`${baseUrl}/api/method/prime.www.get_lab_test.get_file` , options_no)
